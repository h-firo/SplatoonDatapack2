...
summon armor_stand ^ ^ ^2.0 {Tags:["shot$(team)","ink","owner$(num)","charger"],Invisible:true,Silent:true,data:{team:$(team),owner:$(num),shotNum:$(shotNum),damageAT:$(DamageAT),objDamage:$(obj),speed:0.0022},attributes:[{id:"minecraft:gravity",base:0},{id:"minecraft:scale",base:0.1}]}
$execute if score @s chargeTo100 matches 70.. positioned ~ ~1.6 ~ run \
...
$execute if score @s chargeTo100 matches 50.. positioned ~ ~1.6 ~ run \
summon armor_stand ^ ^ ^2.0 {Tags:["shot$(team)","ink","owner$(num)","charger"],Invisible:true,Silent:true,data:{team:$(team),owner:$(num),shotNum:$(shotNum),damageAT:$(DamageAT),objDamage:$(obj),speed:0.0015},attributes:[{id:"minecraft:gravity",base:0},{id:"minecraft:scale",base:0.1}]}
$execute if score @s chargeTo100 matches 10.. positioned ~ ~1.6 ~ run \
summon armor_stand ^ ^ ^2.0 {Tags:["shot$(team)","ink","owner$(num)","charger"],Invisible:true,Silent:true,data:{team:$(team),owner:$(num),shotNum:$(shotNum),damageAT:$(DamageAT),objDamage:$(obj),speed:0.001},attributes:[{id:"minecraft:gravity",base:0},{id:"minecraft:scale",base:0.1}]}
