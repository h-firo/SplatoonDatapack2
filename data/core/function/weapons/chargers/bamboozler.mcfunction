...
execute if score @s damage matches ..30 if score @s chargeTo100 matches ..99 run scoreboard players set @s damage 30
...
playsound block.dispenser.launch master @a ~ ~ ~ 1 1