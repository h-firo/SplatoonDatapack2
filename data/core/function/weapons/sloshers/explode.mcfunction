...
$execute as @e[distance=..2.3,tag=player] unless entity @s[level=$(owner)] unless score @s team matches $(team) run function core:damages/remove_health {value:35,type:"main",killer:$(owner)}
