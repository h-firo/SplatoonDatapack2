...
$execute positioned ~ ~1.6 ~ run \
summon armor_stand ^0.2 ^ ^1 {Tags:["shot$(team)","ink","owner$(num)","general"],Invisible:true,Silent:true,data:{team:$(team),owner:$(num),damage:$(Damage),shotNum:$(shotNum),damageAT:$(DamageAT),objDamage:$(obj)},attributes:[{id:"minecraft:gravity",base:$(Gravity)},{id:"minecraft:scale",base:0.1}]}
$execute positioned ~ ~1.6 ~ run \
summon armor_stand ^-0.2 ^ ^1 {Tags:["shot$(team)","ink","owner$(num)","general"],Invisible:true,Silent:true,data:{team:$(team),owner:$(num),damage:$(Damage),shotNum:$(shotNum),damageAT:$(DamageAT),objDamage:$(obj)},attributes:[{id:"minecraft:gravity",base:$(Gravity)},{id:"minecraft:scale",base:0.1}]}
$execute positioned ~ ~1.6 ~ run \
...
$execute positioned ~ ~1.6 ~ run \
summon armor_stand ^ ^ ^0.5 {Tags:["shot$(team)","ink","owner$(num)","general"],Invisible:true,Silent:true,data:{team:$(team),owner:$(num),damage:$(Damage),shotNum:$(shotNum),damageAT:$(DamageAT),objDamage:$(obj)},attributes:[{id:"minecraft:gravity",base:$(Gravity)},{id:"minecraft:scale",base:0.1}]}
...
scoreboard players remove @s ink 120
$scoreboard players set @s shotDelay $(FireRate2)
$scoreboard players add @s accuracy $(Blur)

$tag @e[type=armor_stand,tag=shot$(num)] remove shot$(num)