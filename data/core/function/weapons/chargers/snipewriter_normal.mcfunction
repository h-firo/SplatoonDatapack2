...
scoreboard players remove @s snipewriterBullet 1
...
playsound block.iron_trapdoor.close master @s ~ ~ ~ 1 1
playsound entity.fishing_bobber.throw master @s ~ ~ ~ 1 0.9
playsound entity.wind_charge.wind_burst master @s ~ ~ ~ 1 1