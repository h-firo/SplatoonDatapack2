...
execute if score value gameRule matches 2 if score team1 areaCount > maxCount checkPoint run return run function stage:gimmick/waterleveldrop
execute if score value gameRule matches 2 if score team2 areaCount > maxCount checkPoint run return run function stage:gimmick/waterleveldrop