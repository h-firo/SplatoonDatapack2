...
bundle[bundle_contents=[{id:"diamond",components:{"item_model":"subweapon","custom_model_data":{strings:["inkmine"]}}},\
                        ...
                        {id:"diamond",components:{"item_model":"spread","custom_model_data":{strings:["large"]}}}],\
                        item_name={translate:"item.weapon.tentabrella",bold:true},item_model="tentabrella_open",custom_data={item:"button",type:"weapon",content:"tentabrella"},\
                        lore=[{"color":"gray","translate":"item.weapon.tentabrella.lore1"},{"color":"gray","translate":"item.weapon.tentabrella.lore2"}]]