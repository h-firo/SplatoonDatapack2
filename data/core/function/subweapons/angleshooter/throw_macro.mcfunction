...
summon armor_stand ^ ^ ^2 {Tags:["marker$(bombNum)","bomb","owner$(num)"],Invisible:false,Silent:true,Small:true,data:{team:$(team),owner:$(num),bombNum:$(bombNum),type:"angleshooter_marker",color:$(color)},NoGravity:true}
