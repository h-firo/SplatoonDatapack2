...
$data modify storage player: $(num).weapon.FireRate set value $(RollFireRate)
$data modify storage player: $(num).weapon.DamageAT set value $(RollDamageAT)
$data modify storage player: $(num).weapon.Speed set value $(RollFireSpeed)
$data modify storage player: $(num).weapon.Damage set value $(RollDamage)
