#射撃キャンセル
$data modify storage shot_temp: $(XpLevel).FireRate set from storage player: $(XpLevel).weapon.FireRate
$data modify storage shot_temp: $(XpLevel).DamageAT set from storage player: $(XpLevel).weapon.DamageAT
