...
execute if score @s damage matches 70.. if score @s chargeTo100 matches ..99 run scoreboard players set @s damage 80
...
$execute if score @s chargeTo100 matches 80.. positioned ~ ~1.6 ~ run \
summon armor_stand ^ ^ ^2.0 {Tags:["shot$(team)","ink","owner$(num)","charger"],Invisible:true,Silent:true,Small:true,data:{team:$(team),owner:$(num),shotNum:$(shotNum),damageAT:$(DamageAT),objDamage:$(obj),speed:0.0013},attributes:[{id:"minecraft:gravity",base:0},{id:"minecraft:scale",base:0.1}]}
...
$execute if score @s chargeTo100 matches 40.. positioned ~ ~1.6 ~ run \
summon armor_stand ^ ^ ^2.0 {Tags:["shot$(team)","ink","owner$(num)","charger"],Invisible:true,Silent:true,Small:true,data:{team:$(team),owner:$(num),shotNum:$(shotNum),damageAT:$(DamageAT),objDamage:$(obj),speed:0.0007},attributes:[{id:"minecraft:gravity",base:0},{id:"minecraft:scale",base:0.1}]}
$execute if score @s chargeTo100 matches 20.. positioned ~ ~1.6 ~ run \
summon armor_stand ^ ^ ^2.0 {Tags:["shot$(team)","ink","owner$(num)","charger"],Invisible:true,Silent:true,Small:true,data:{team:$(team),owner:$(num),shotNum:$(shotNum),damageAT:$(DamageAT),objDamage:$(obj),speed:0.0006},attributes:[{id:"minecraft:gravity",base:0},{id:"minecraft:scale",base:0.1}]}
$execute positioned ~ ~1.6 ~ run \
summon armor_stand ^ ^ ^2.0 {Tags:["shot$(team)","ink","owner$(num)","charger"],Invisible:true,Silent:true,Small:true,data:{team:$(team),owner:$(num),shotNum:$(shotNum),damageAT:$(DamageAT),objDamage:$(obj),speed:0.0004},attributes:[{id:"minecraft:gravity",base:0},{id:"minecraft:scale",base:0.1}]}
