...
execute if score value gameRule matches 2 if score team1 checkPoint matches 1 run return run function stage:gimmick/waterleveldrop
execute if score value gameRule matches 2 if score team2 checkPoint matches 1 run return run function stage:gimmick/waterleveldrop