...
execute if items entity @s player.cursor *[custom_data~{content:"splattershotjr"}] run function command:set_weapon {category:shooter,weapon:splattershotjr}
...
execute if items entity @s player.cursor *[custom_data~{content:"flingzaroller"}] run function command:set_weapon {category:roller,weapon:flingzaroller}
...
execute if items entity @s player.cursor *[custom_data~{content:"bamboozler"}] run function command:set_weapon {category:charger,weapon:bamboozler}
...
execute if items entity @s player.cursor *[custom_data~{content:"rapidblaster"}] run function command:set_weapon {category:blasters,weapon:rapidblaster}
execute if items entity @s player.cursor *[custom_data~{content:"rapidblasterpro"}] run function command:set_weapon {category:blasters,weapon:rapidblasterpro}
...
execute if items entity @s player.cursor *[custom_data~{content:"ballpointsplatling"}] run function command:set_weapon {category:splatlings,weapon:ballpointsplatling}
...
execute if items entity @s player.cursor *[custom_data~{content:"dualiesquelchers"}] run function command:set_weapon {category:dualies,weapon:dualiesquelchers}
...
execute if items entity @s player.cursor *[custom_data~{content:"tetradualies"}] run function command:set_weapon {category:dualies,weapon:tetradualies}
