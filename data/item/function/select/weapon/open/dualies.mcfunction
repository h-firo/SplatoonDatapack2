...
bundle[bundle_contents=[{id:"diamond",components:{"item_model":"subweapon","custom_model_data":{strings:["splashbomb"]}}},\
                        ...
                        {id:"diamond",components:{"item_model":"spread","custom_model_data":{strings:["middle"]}}}],\
                        item_name={translate:"item.weapon.dappledualies",bold:true},item_model="dappledualies",custom_data={item:"button",type:"weapon",content:"dappledualies"},\
                        lore=[{"color":"gray","translate":"item.weapon.dappledualies.lore1"},{"color":"gray","translate":"item.weapon.dappledualies.lore2"}]]
