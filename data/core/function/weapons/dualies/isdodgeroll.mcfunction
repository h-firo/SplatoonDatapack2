#インクがある？
$execute unless score @s ink matches $(RollInk).. run return fail
...
#最大スライド回数を取得
$execute store result score @s maxDodgerollCount run data get storage shot_temp: $(num).MaxRolls 1
