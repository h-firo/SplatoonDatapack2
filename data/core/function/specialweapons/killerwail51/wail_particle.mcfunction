...
$execute as @e[tag=player,distance=..0.3,tag=!killerwail$(owner)] unless score @s team matches $(team) run function core:damages/remove_health {value:2,type:"killerwail",killer:$(owner)}
