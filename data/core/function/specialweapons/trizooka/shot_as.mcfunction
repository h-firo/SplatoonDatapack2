...
#Motionの値に計算結果を代入
execute store result entity @s Motion[0] double 0.0017 run scoreboard players get @s shotX
execute store result entity @s Motion[1] double 0.0017 run scoreboard players get @s shotY
execute store result entity @s Motion[2] double 0.0017 run scoreboard players get @s shotZ