...
bundle[bundle_contents=[{id:"diamond",components:{"item_model":"subweapon","custom_model_data":{strings:["toxicmist"]}}},\
                        ...
                        item_name={translate:"item.weapon.minisplatling",bold:true},item_model="minisplatling",custom_data={item:"button",type:"weapon",content:"minisplatling"},\
                        lore=[{"color":"gray","translate":"item.weapon.minisplatling.lore1"},{"color":"gray","translate":"item.weapon.minisplatling.lore2"}]]
...
bundle[bundle_contents=[{id:"diamond",components:{"item_model":"subweapon","custom_model_data":{strings:["sprinkler"]}}},\
                        ...
                        {id:"diamond",components:{"item_model":"spread","custom_model_data":{strings:["middle"]}}}],\
                        item_name={translate:"item.weapon.heavysplatling",bold:true},item_model="heavysplatling",custom_data={item:"button",type:"weapon",content:"heavysplatling"},\
                        lore=[{"color":"gray","translate":"item.weapon.heavysplatling.lore1"},{"color":"gray","translate":"item.weapon.heavysplatling.lore2"}]]
