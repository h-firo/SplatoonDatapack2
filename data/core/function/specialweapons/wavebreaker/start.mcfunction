...
$data modify entity @n[type=armor_stand,tag=waveBreaker$(num)] data.r set from storage dustcolor: $(team).r
$data modify entity @n[type=armor_stand,tag=waveBreaker$(num)] data.g set from storage dustcolor: $(team).g
$data modify entity @n[type=armor_stand,tag=waveBreaker$(num)] data.b set from storage dustcolor: $(team).b
