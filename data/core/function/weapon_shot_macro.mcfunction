...
$execute if data storage player: {$(XpLevel):{category:charger}} if score @s shotDelay matches ..0 if score @s ink matches 1.. if score @s chargeKeepTime matches -1 unless score @s charged matches 1 run \
...
$execute if data storage player: {$(XpLevel):{category:sloshers}} if score @s shotDelay matches ..0 if score @s ink matches 1.. run \
...
$execute if data storage player: {$(XpLevel):{category:dualies}} if score @s shotDelay matches ..0 if score @s ink matches 1.. run \
